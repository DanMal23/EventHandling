...
public class TextButtonLabel1 extends JFrame {
	public static void main(String[] a) {
		new TextButtonLabel1();
	}

	public TextButtonLabel1() {
		...
		JButton b1 = new JGradientButton1(" >>> ", Color.WHITE, Color.BLACK);
		...
		JButton b2 = new JGradientButton1(" >>> ", Color.WHITE, Color.BLACK);
		...
		JButton b3 = new JGradientButton1(" >>> ", Color.WHITE, Color.BLACK);
